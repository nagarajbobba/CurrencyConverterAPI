...
namespace CurrencyConverter.API.Tests.V1
{
    ...
    public class CurrencyConverterIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    {
        private readonly WebApplicationFactory<Program> _factory;
        public CurrencyConverterIntegrationTests(WebApplicationFactory<Program> factory)
        {
            _factory = factory;
        }
